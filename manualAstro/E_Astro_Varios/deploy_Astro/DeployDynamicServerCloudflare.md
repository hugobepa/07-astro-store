...
0. paginas donde params dinamicos o apiREST: `export const prerender = false;`( antes funcion principal)
...
8. añadir variables de entorno:
   - hacer commit y push de los cambios hechos en VS
     -(cloudfare)[https://www.cloudflare.com/es-es/]
   - dashBoard -- workers & Pages- escoger proyecto -- settings -- variables ans secrets
     - ADD: type: text o secret(token) , variable name: ASTRO_DB_REMOTE_URL=, value: xxxxxx
     - add variable o save
     - branch control: escoger rama actual + save
   - problema de astro estudio VS , eliminar elementos 'astro estudio' de app.json:
     - eleminar package-lock.json
     - eliminar modules
     - T: npm i
     - commit i push github
